...
// const navLinks = [
//   { icon: <VscGraph />, label: 'Activity', path: '/account' },
...
//               key={index}
//               to={item.path}
//               className={`flex items-center gap-3 w-full xs:p-3 p-2 xs:text-base text-xs rounded-lg transition-colors ${activeTab === item.path
