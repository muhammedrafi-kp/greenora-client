...
const AgentNavbar: React.FC = () => {
    ...
    return (
        <>
            <nav className="bg-green-100 text-slate-950 p-1 shadow-md  w-full" >
                <div className="container mx-auto flex items-center justify-between">
                    ...
                    {/* Navigation Links */}
                    <div className="hidden md:flex md:items-center md:space-x-6 mr-10 font-medium">
                        ...
                        <div className="bg-white relative flex items-center gap-2 border rounded-full cursor-pointer py-1 px-2 shadow-md">
                            ...
                            {/* Dropdown Menu */}
                            {isDropdownOpen && (
                                <div className="absolute right-0 mt-52 w-48 bg-white shadow-md rounded-2xl text-slate-950 border p-3" ref={dropdownRef}>
